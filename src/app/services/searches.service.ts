...
export class SearchesService {
  ...
  private transformAnyToUser(result:any[]):User[]{//especificandose que el metodo recibe cierta Data(result),
    return result.map(                            //de tipo any , y su salida debe ser de tipo User
